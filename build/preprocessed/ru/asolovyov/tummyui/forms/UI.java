...
import ru.asolovyov.tummyui.forms.views.UIGroup;
...
import ru.asolovyov.tummyui.forms.views.UIIf;
import ru.asolovyov.tummyui.forms.views.UIAlert;
import ru.asolovyov.tummyui.forms.views.UITextField;
import ru.asolovyov.tummyui.forms.views.UIImageItem;
import ru.asolovyov.tummyui.forms.views.UIGauge;
import ru.asolovyov.tummyui.forms.views.UIDateField;
import ru.asolovyov.tummyui.forms.views.UIStringItem;
import ru.asolovyov.tummyui.forms.views.UIChoiceGroup;
...
public class UI {
    ...
    public static UIDateField DateField(String label, int mode, Date date) {
        return DateField(new Str(label), mode, new Obj(new Date()));
    }

    public static UIDateField DateField(int mode, Date date) {
        return DateField(mode, new Obj(new Date()));
    }
    ...
    public static UITextBox TextBox(String label, Str text) {
        return new UITextBox(new Str(label), text);
    }

    public static UITextBox TextBox(Str label, Str text) {
        return new UITextBox(label, text);
    }

    public static UITextBox TextBox(String label, String text) {
        return new UITextBox(new Str(label), new Str(text));
    }
